...
import qc.browser.light.BuildConfig;
import qc.browser.light.R;
import qc.browser.light.adblock.AdBlocker;
...
import qc.browser.light.js.InvertPage;
import qc.browser.light.js.TextReflow;
