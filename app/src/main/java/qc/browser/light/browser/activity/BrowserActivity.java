...
package qc.browser.light.browser.activity;
...
import qc.browser.light.IncognitoActivity;
import qc.browser.light.MyDialog;
import qc.browser.light.R;
import qc.browser.light.browser.BookmarksView;
import qc.browser.light.browser.BrowserPresenter;
import qc.browser.light.browser.BrowserView;
import qc.browser.light.browser.SearchBoxModel;
import qc.browser.light.browser.TabsManager;
import qc.browser.light.browser.TabsView;
...
import qc.browser.light.controller.UIController;
...
import qc.browser.light.interpolator.BezierDecelerateInterpolator;
...
import qc.browser.light.search.engine.BaseSearchEngine;
import qc.browser.light.settings.activity.SettingsActivity;
import qc.browser.light.utils.DrawableUtils;
import qc.browser.light.utils.IntentUtils;
import qc.browser.light.utils.Preconditions;
import qc.browser.light.utils.ProxyUtils;
import qc.browser.light.utils.ThemeUtils;
import qc.browser.light.utils.UrlUtils;
import qc.browser.light.utils.Utils;
import qc.browser.light.utils.WebUtils;
import qc.browser.light.view.Handlers;
import qc.browser.light.view.LightningView;
import qc.browser.light.view.SearchView;
...
//                        if (mTheme == 0) {
//
//                            d.findViewById(R.id.linParent).setBackgroundColor(Color.WHITE);
//                        } else if (mTheme == 1) {
//                            d.findViewById(R.id.linParent).setBackgroundColor(Color.BLACK);
//                        } else if (mTheme == 2) {
//                            d.findViewById(R.id.linParent).setBackgroundColor(Color.BLACK);
//                        }
//
...
//                        });
    ...
    @NonNull
    protected Completable clearCookies() {
        return Completable.create(new CompletableAction() {
            @Override
            public void onSubscribe(@NonNull CompletableSubscriber subscriber) {
                Activity activity = BrowserActivity.this;
                if (activity != null) {
        ...
        return Completable.create(new CompletableAction() {
            ...
            public void onSubscribe(@NonNull CompletableSubscriber subscriber) {
                if (BrowserActivity.this != null) {
                    ...
                    WebUtils.clearHistory(BrowserActivity.this, mHistoryModel);
                    subscriber.onComplete();
                }
    ...
    public void changeToolbarBackground(@NonNull Bitmap favicon, @Nullable final Drawable tabBackground) {
        final int defaultColor = ContextCompat.getColor(this, R.color.colorPrimary);
...
//                                startSearchColor, finalSearchColor), PorterDuff.Mode.SRC_IN);
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(BrowserActivity.this, "Please allow the Permission otherwise App Not Runs!!!", Toast.LENGTH_SHORT).show();
    ...
    public void ReloadCurrentTab(View v) {
        vibe.vibrate(100);
        LightningView currentTab = mTabsManager.getCurrentTab();
        if (currentTab != null) {
            currentTab.reload();
    ...
    public void openDesktopVersion() {
        LightningView current = mTabsManager.getCurrentTab();
        if (current != null) {
            current.toggleDesktopUA(this);
            current.reload();
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(BrowserActivity.this , "Your Page is Saved..." , Toast.LENGTH_SHORT).show();
        }
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                final LightningView currentTab = mTabsManager.getCurrentTab();
                final String title = currentTab != null ? currentTab.getTitle() : System.currentTimeMillis() + "";
                ...
                OutputStream output = new FileOutputStream(file.getAbsolutePath() + "/" + System.currentTimeMillis() + ".html");
